    ...
    <div className="print-content bg-white p-4">
      <div className="flex flex-col items-center mb-4">
        ...
        <div className="text-center mt-2">
          <h1 className="text-xl font-bold showName">{showName}</h1>
      ...
      <table className="w-full border-collapse border border-gray-200 mb-4 text-sm">
        <thead>
          <tr>
            ...
            {showMinutes && (
              <th className="py-1 px-2 text-center border border-gray-200 text-sm w-16">דק'</th>
            )}
          </tr>
        </thead>
        <tbody>
                  ...
                  return (
                    <React.Fragment key={item.id}>
                      <tr>
                        ...
                        {showMinutes && (
                          <td className="py-1 px-2 text-center border border-gray-200 text-sm w-16"
                              rowSpan={intervieweeCount + 1}>
                            {item.duration}
                          </td>
                        )}
        ...
        {showMinutes && (
          <tfoot>
            <tr>
              ...
              <td className="py-1 px-2 text-center font-bold border border-gray-200 w-16 text-sm">
