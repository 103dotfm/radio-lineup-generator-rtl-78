...
async function fixIsraeliWeek() {
  try {
    ...
    const weekInfo = await pool.query(`
      SELECT 
    ...
    console.log(`Inserted ${insertResult.rowCount} new slots`);
    ...
    verifyResult.rows.forEach(slot => {
