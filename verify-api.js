...
const bookings = await query('SELECT title, start_time, end_time FROM studio_bookings WHERE booking_date = $1 AND studio_id = 2 ORDER BY start_time', [todayStr]);

console.log('\nAPI RESULT for today (אולפן ב\'):');
